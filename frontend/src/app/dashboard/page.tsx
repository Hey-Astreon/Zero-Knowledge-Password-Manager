...
import { Plus, Search, LogOut, Key, Star, Zap, Eye, EyeOff, PlayCircle, Lock, ShieldCheck } from 'lucide-react';
            ...
            <div className="flex-1 flex max-w-[1280px] mx-auto w-full px-6 py-8 gap-8">
                ...
                <aside className="w-64 hidden md:flex flex-col gap-3">
                    <button 
                        ...
                        className="mb-4 h-12 w-full bg-[#7342E2] hover:bg-[#6836D1] text-white font-semibold rounded-full shadow-[0_4px_24px_rgba(115,66,226,0.28)] flex items-center justify-center gap-2.5 transition-all active:scale-95 text-sm"
                    >
                        <Plus size={18} />
                        Add New Password
                    </button>
                    ...
                    <div className="mt-auto p-4 rounded-2xl bg-[#F2F2EE] border border-[#192837]/10 space-y-2">
